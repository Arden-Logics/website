            ...
            <div className="w-full space-y-16 px-8 sm:px-12 lg:px-24 xl:px-32">
                <div className="grid gap-12 lg:grid-cols-5">
                    <div className="space-y-6 lg:col-span-2 lg:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">Arden 360 provides comprehensive IT, Security, and AV solutions for modern businesses.</p>
                    </div>
                            ...
                            <div
                                ...
                                <div className="flex flex-wrap gap-4 sm:flex-col">
                                    ...
                                    {link.group === 'Quick Links' && (
                                        <ContactSalesDialog>
                                            <span className="text-foreground hover:text-primary block text-sm duration-150 cursor-pointer">
                                                Contact Sales
                                            </span>
                                        </ContactSalesDialog>
                                    )}
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} Arden 360, All rights reserved </span>
