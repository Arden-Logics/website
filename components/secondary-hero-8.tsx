                                ...
                                {features.map((feature, index) => (
                                    <div
                                        ...
                                        <div className={`flex size-8 items-center justify-center rounded-md shadow ring-1 *:size-4 ${backgroundImageSrc ? 'bg-white/10 ring-white/20' : 'bg-card ring-border-illustration'}`}>
                                            {React.isValidElement(feature.icon) ? React.cloneElement(feature.icon as React.ReactElement<{ className?: string }>, { 
                                                className: backgroundImageSrc ? 'stroke-white fill-white/15' : (feature.icon as React.ReactElement<{ className?: string }>).props.className 
                                            }) : feature.icon}
                                        </div>
