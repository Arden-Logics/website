...
export default function FeaturesSection({ serviceKey, solutionKey }: FeaturesHeroProps) {
    ...
    return (
        <section className="overflow-hidden min-h-screen flex items-center sm:py-16 md:py-8 lg:py-0">
            <div className="bg-zinc-50 w-full">
                {/* Full-width hero content */}
                <div className="w-full px-8 sm:px-12 lg:px-24 xl:px-32">
                    <div className="grid items-center gap-8 md:grid-cols-[1.4fr_1.6fr] lg:grid-cols-[1.2fr_2fr] lg:gap-12">
                        <div>
                        ...
                        <div className="flex justify-end md:justify-start lg:justify-end">
                            <div className="relative w-full aspect-[3/4] lg:aspect-[4/3] overflow-hidden rounded-2xl pt-2 md:pt-2 lg:pt-10 md:translate-x-4 lg:translate-x-0">
                                <Image
                                    src={imageSrc}
                                    alt={imageAlt}
