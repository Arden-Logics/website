...
const slides: CarouselSlide[] = [
  ...
  },
  {
    ...
    description:
      "Arden 360 delivers fully managed IT services, remote helpdesk support, proactive monitoring, patching, and strategic IT management for businesses of all sizes. Improve reliability, security, and performance with a dedicated MSP partner.",
...
export default function HeroCarousel() {
  ...
  return (
    <section className="relative h-[calc(100vh-104px)] max-lg:h-[calc(100vh-96px)] max-lg:mt-24 flex items-center overflow-hidden bg-secondary">
