                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 *:p-8">
                        <div className="bg-card ring-foreground/10 grid grid-rows-[auto_1fr] space-y-12 overflow-hidden rounded-2xl border border-transparent shadow-md shadow-black/5 ring-1">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-3">
                                    Arden 360 delivers forward-looking IT leadership backed by certified engineers across cybersecurity, cloud, AV, networking, and physical security. We proactively plan, prevent issues, and architect systems that keep organizations ahead of risk and ahead of change.
                                </p>
                            </div>
                        </div>
                        <div className="bg-card ring-foreground/10 grid grid-rows-[auto_1fr] space-y-12 overflow-hidden rounded-2xl border border-transparent shadow-md shadow-black/5 ring-1">
                        ...
                        <div className="bg-card ring-foreground/10 grid grid-rows-[auto_1fr] space-y-12 overflow-hidden rounded-2xl border border-transparent shadow-md shadow-black/5 ring-1">
                            <div>
                                ...
                                <p className="text-muted-foreground mt-3">
                                    Our U.S.-based support and real-time monitoring detect and resolve issues before they create impact. Arden 360 is trusted by organizations of all sizes to power mission-critical operations with reliability, speed, and a long-standing track record of customer success.
                                </p>
                            </div>
                        </div>
                    </div>
