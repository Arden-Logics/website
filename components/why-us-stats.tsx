...
export default function WhyUsStats() {
  return (
    <section 
      aria-label="Why choose Arden 360" 
    ...
    >
      ...
      >
        <Image
          ...
          alt="Arden 360 performance metrics and managed IT reliability background"
          fill
          sizes="70vw"
      ...
      <div className="relative w-full px-8 sm:px-12 lg:px-24 xl:px-32">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed max-w-xl mb-12">
            From fast-growing startups to established enterprises, businesses across every industry rely on Arden 360 to strengthen their security posture, optimize their systems, and stay connected from anywhere.
          </p>
