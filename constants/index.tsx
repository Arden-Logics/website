...
export const SOLUTIONS_DATA: SolutionDetail[] = [
    ...
    },
    {
        ...
        description: 'Educational institutions and campus IT solutions.',
        icon: <BookOpen className="stroke-foreground fill-blue-500/15" />,
        images: [
            '/solutions/education/education-1.jpg',
            '/solutions/education/education-2.jpg',
            '/solutions/education/education-3.jpg',
        ],
    },
    {
        name: 'Government',
        href: '/solutions/government',
        description: 'Government and public sector IT solutions.',
        icon: <Building2 className="stroke-foreground fill-slate-500/15" />,
        images: [
            '/solutions/government/government-1.jpg',
            '/solutions/government/government-2.jpg',
            '/solutions/government/government-3.jpg',
        ],
    },
    {
        name: 'Healthcare',
        href: '/solutions/healthcare',
        description: 'Healthcare IT and clinical infrastructure solutions.',
        icon: <Heart className="stroke-foreground fill-red-500/15" />,
        images: [
            '/solutions/healthcare/healthcare-1.jpg',
            '/solutions/healthcare/healthcare-2.jpg',
            '/solutions/healthcare/healthcare-3.jpg',
        ],
    },
    {
        name: 'Retail',
        href: '/solutions/retail',
        description: 'Multi-location retail operations and solutions.',
        icon: <ShoppingCart className="stroke-foreground fill-amber-500/15" />,
        images: [
            '/solutions/retail/retail-1.jpg',
            '/solutions/retail/retail-2.jpg',
            '/solutions/retail/retail-3.jpg',
        ],
    },
    {
        name: 'Financial',
        href: '/solutions/financial',
        description: 'Financial services security and operations.',
        icon: <LineChart className="stroke-foreground fill-green-500/15" />,
        images: [
            '/solutions/financial/financial-1.jpg',
            '/solutions/financial/financial-2.jpg',
            '/solutions/financial/financial-3.jpg',
        ],
    },
]
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                href: '/solutions/financial',
                description: 'Financial services security and operations.',
                icon: <Cpu className="stroke-foreground fill-green-500/15" />,
            },
            {
                name: 'Education',
                href: '/solutions/education',
                description: 'Educational institutions and campus IT.',
            ...
            },
            {
                ...
                icon: <Cpu className="stroke-foreground fill-amber-500/15" />,
            },
            {
                name: 'Tech',
                href: '/solutions/tech',
...
export const SERVICE_CONTENT: Record<string, ServiceContent> = {
    'msp-managed-it': {
        ...
        description: 'Ensure uptime, productivity, and long-term stability with fully managed IT support tailored to your organization. Arden 360 delivers proactive monitoring, expert guidance, and end-to-end technology management built to keep your operations running smoothly.',
        ctaText: 'Contact us',
        ctaLink: '#contact',
        features: [
            {
        ...
        contentFeatures: [
            ...
            },
            {
                icon: <ShieldCheck className="stroke-foreground fill-foreground/10" />,
                title: 'Cybersecurity',
                description: 'Protect your organization with a layered security strategy that adapts as threats evolve. Arden 360 delivers next-generation defenses including endpoint protection, MFA, threat detection, vulnerability management, and zero-trust controls designed to secure every user, device, and workflow.',
            ...
            },
            {
                ...
                description: 'Stay operational even during unexpected downtime. Arden 360 designs and manages comprehensive backup, failover, and recovery strategies to protect critical data and applications. From ransomware resilience to cloud-based DR solutions, we keep your business running no matter what.',
            ...
            },
            {
                ...
                description: 'Give your team a frictionless IT experience. Arden 360 handles onboarding, offboarding, device provisioning, permissions, software access, troubleshooting, and day-to-day technical support, ensuring employees stay productive and secure everywhere they work.',
            ...
            },
            {
                ...
                description: 'Stay ahead of vulnerabilities with automated, centralized patching for operating systems, applications, and third-party software. Arden 360 tests, schedules, and deploys updates in a way that minimizes disruptions while maximizing security and performance.',
        ...
        contentSection: {
            ...
            highlights: [
                'Arden 360 delivers modern, scalable IT solutions that empower organizations to operate securely, efficiently, and without interruption.',
        ...
        metricsSection: {
            ...
            description: 'Arden 360 provides proactive monitoring, security oversight, and infrastructure management to keep systems stable, secure, and performing as intended without added operational burden',
            metrics: [
    ...
    'network-cabling': {
        ...
        subtitle: 'Network & Cabling Solutions that support how you operate, now and tomorrow',
        description: 'We design and install network infrastructure and structured cabling that aligns with real-world usage, performance needs, and future expansion',
        ctaText: 'Contact us',
        ctaLink: '#contact',
        features: [
            {
        ...
        heroSection: {
            ...
            description: 'Arden 360 builds fast, reliable, and scalable network infrastructure with structured cabling solutions designed to support your organization today and grow with you tomorrow.',
            buttonText: 'Contact us',
            buttonLink: '#contact',
        ...
        contentSection: {
            ...
            highlights: [
                'Arden 360 delivers mission-critical network and cabling infrastructure engineered for resilience, scalability, and high availability ensuring your organization stays connected and operational across every environment.',
                'Arden 360 builds network foundations that support large-scale operations, high-density device environments, and bandwidth-intensive workloads. Every installation follows industry standards, ensuring predictable performance and long-term reliability.',
                ...
                'Arden 360 delivers infrastructure that is secure, compliant, and future-ready enabling your organization to operate with speed, stability, and confidence across all business units.',
            ]
        },
        metricsSection: {
            title: 'Network Infrastructure Designed for Reliability and Growth',
            description: 'Arden 360 designs and deploys network and structured cabling infrastructure that supports secure connectivity, consistent performance, and long-term scalability across offices, campuses, and enterprise environments',
            metrics: [
    ...
    'audio-visual': {
        ...
        description: 'Arden 360 delivers modern, scalable audio-visual solutions that enhance communication, collaboration, and client experience across your organization. From conference rooms to campus-wide systems, we design, install, and support AV environments that work anywhere and grow with you.',
        ctaText: 'Contact us',
        ctaLink: '#contact',
        features: [
            {
        ...
        heroSection: {
            ...
            description: 'From conference rooms to campus-wide systems, we design, install, and support AV environments that work anywhere and grow with you.',
            buttonText: 'Contact us',
            buttonLink: '#contact',
        ...
        metricsSection: {
            ...
            description: 'Arden 360 designs and deploys audio-visual systems that are consistent, predictable, and easy to operate so meeting rooms, training spaces, and collaboration areas work the same way every time',
            metrics: [
        ...
        whyArdenContent: {
            ...
            solutionSubtitle: 'Imagine AV that never slows your meetings down. With Arden 360, you get:',
            benefits: [
    ...
    'camera-access-security': {
        ...
        featuresSectionDescription: 'Arden 360 designs and deploys physical security systems that unify video surveillance, access control, and monitoring into a single, manageable environment',
        contentFeatures: [
            {
                icon: <Camera className="stroke-foreground fill-foreground/10" />,
                title: 'Connected camera ecosystems',
    ...
    'voip': {
        ...
        description: 'Clear, reliable cloud-based voice, texting, and call management built for mobility and responsiveness. Arden 360 provides HD voice quality with advanced call routing, auto-attendants, queues, ring groups, and intelligent call flows accessible from any device.',
        ctaText: 'Contact us',
        ctaLink: '#contact',
        features: [
            {
        ...
        heroSection: {
            ...
            description: 'Empower your organization with a modern cloud-based VoIP phone system designed for clarity, reliability, and scalability.',
            buttonText: 'Contact us',
            buttonLink: '#contact',
        ...
        featuresSectionDescription: 'Arden 360 delivers a flexible, cloud-based phone system designed to keep your team connected from anywhere. With intelligent routing, mobility tools, and crystal-clear call quality, our solution grows with your organization and adapts to how you work.',
        contentFeatures: [
            {
                icon: <Zap className="stroke-foreground fill-foreground/10" />,
        ...
        contentSection: {
            ...
            highlights: [
                'Arden 360 delivers a modern VoIP platform engineered for reliability, mobility, and business-grade performance across all devices. Our cloud phone system enhances collaboration, improves responsiveness, and keeps teams connected from anywhere.',
        ...
        metricsSection: {
            ...
            description: 'Arden 360 delivers secure, reliable cloud VoIP phone systems designed for modern business communication. Our solutions support desk phones, mobile devices, and softphones providing consistent call quality, flexibility, and uptime across locations',
            metrics: [
                ...
                { value: '92%', label: 'Average reduction in dropped calls after migrating to Arden 360 VoIP.' },
            ]
        },
        whyArdenContent: {
            problemTitle: 'Communication should be effortless.',
            problemSubtitle: 'Yet most phone providers make it frustrating. Delays, outages, and inflexible systems slow your team down and cost your business money. With Arden 360 VoIP, communication becomes a strategic advantage.',
            painPoints: [
            ...
            solutionSubtitle: 'Imagine a phone system that just works every call, every device, every location. With Arden 360 VoIP, you get:',
            benefits: [
            ...
            differenceText: 'This is the Arden 360 VoIP difference.',
    ...
    'cybersecurity': {
        ...
        description: 'Arden 360 delivers modern, adaptive cybersecurity built to defend your organization from today\'s threats and tomorrow\'s unknowns. From endpoint protection to full threat monitoring, we secure your systems, data, and people with solutions that scale effortlessly.',
        ctaText: 'Contact us',
        ctaLink: '#contact',
        features: [
            {
        ...
        heroSection: {
            ...
            description: 'Arden 360 delivers modern, adaptive cybersecurity built to defend your organization from today\'s threats and tomorrow\'s unknowns.',
            buttonText: 'Contact us',
            buttonLink: '#contact',
        ...
        whyArdenContent: {
            ...
            solutionSubtitle: 'When your organization is protected the right way, you gain control, clarity, and confidence. With Arden 360, you get:',
            benefits: [
...
export const SOLUTION_CONTENT: Record<string, SolutionContent> = {
    'enterprise': {
        ...
        description: 'Arden 360 delivers comprehensive, scalable IT solutions designed for enterprise organizations. From infrastructure management to security and compliance, we provide the technology foundation your business needs to thrive.',
        ctaText: 'Contact Us',
        ctaLink: '#contact',
        features: [
            {
    ...
    'msp-managed-it': [
        {
            ...
            image: '/services/testimonials/msp/compressed-engineers-discussing-aluminum-window-frames-production-factory.jpg',
        ...
        },
        {
            ...
            image: '/services/testimonials/msp/compressed-full-shot-adults-walking-together.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/msp/compressed-mature-female-with-smartphone-paying-food-products-supermarket-while-standing-by-her-husband-front-happy-young-cashier.jpg',
            link: '/resources/client-success',
        },
    ],
    'network-cabling': [
        {
            ...
            image: '/services/testimonials/network-and-cabling/network-and-cabling-1.webp',
            link: '/resources/client-success',
        },
        {
            id: 2,
            ...
            image: '/services/testimonials/network-and-cabling/network-and-cabling-2.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/network-and-cabling/network-and-cabling-3.jpg',
            link: '/resources/client-success',
        },
    ],
    'audio-visual': [
        {
            ...
            image: '/services/testimonials/audio-visual/audio-visual-1.jpg',
            link: '/resources/client-success',
        },
        {
            id: 2,
            ...
            image: '/services/testimonials/audio-visual/audio-visual-2.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/audio-visual/audio-visual-3.jpg',
            link: '/resources/client-success',
        },
    ],
    'camera-access-security': [
        {
            ...
            image: '/services/testimonials/camera-access-and-security/camera-access-and-security-1.jpg',
            link: '/resources/client-success',
        },
        {
            id: 2,
            ...
            image: '/services/testimonials/camera-access-and-security/camera-access-and-security-2.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/camera-access-and-security/camera-access-and-security-3.jpg',
            link: '/resources/client-success',
        },
    ],
    'cybersecurity': [
        {
            ...
            image: '/services/testimonials/cyber-security/cyber-security-1.jpg',
            link: '/resources/client-success',
        },
        {
            id: 2,
            ...
            image: '/services/testimonials/cyber-security/cyber-security-2.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/cyber-security/cyber-security-3.jpg',
            link: '/resources/client-success',
        },
    ],
    'voip': [
        {
            ...
            image: '/services/testimonials/voip/voip-1.jpg',
            link: '/resources/client-success',
        },
        {
            id: 2,
            ...
            image: '/services/testimonials/voip/voip-2.jpg',
            link: '/resources/client-success',
        },
        {
            id: 3,
            ...
            image: '/services/testimonials/voip/voip-3.jpg',
            link: '/resources/client-success',
        },
    ],
}
