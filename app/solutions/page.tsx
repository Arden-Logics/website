    ...
    return (
        <>
            <ServiceHeroSection
                ...
                description="Arden 360 provides tailored IT solutions across various sectors, helping businesses transform their operations with cutting-edge technology."
