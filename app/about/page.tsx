...
const MILESTONES = [
    {
        ...
        description: 'Arden 360 was founded to provide reliable IT services with a focus on long-term client relationships, operational stability, and practical technology solutions for growing organizations.',
    },
    {
        year: '2013',
...
const CUSTOMER_STATS = [
    ...
    { 
        value: '30%', 
        label: 'Average reduction in communication and IT support costs for clients who transition to Arden 360\' managed platforms.',
        highlight: '',
        highlightLink: ''
    },
    { 
    ...
    return (
        <>
            <SecondaryHero8
                ...
                description={
                    <>
                        At Arden 360, everything begins with the people behind the technology: the teams who rely on it, the leaders who shape it, and the communities it protects. We support thousands of users across dozens of sectors, and every relationship is built on one principle: <strong>trust first, technology second</strong>.
                    </>
                }
            ...
            <section className="py-16 px-6 lg:px-12 text-center">
                <div className="max-w-4xl mx-auto">
                    <div>
                        ...
                        <p className="text-lg text-foreground mb-6">
                            Arden 360 partners with organizations across healthcare, education, financial services, government, fitness, manufacturing, and more. We take time to understand the challenges behind the scenes and deliver solutions that make operations smoother, teams more productive, and growth more achievable.
                        </p>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="col-span-5 row-span-2">
                                    <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-xl">
                                        <Image 
                                            ...
                                            alt="Arden 360 team collaborating on enterprise IT strategy"
                                            fill
                                ...
                                <div className="col-span-7">
                                    <div className="relative h-[240px] rounded-2xl overflow-hidden shadow-xl">
                                        <Image 
                                            ...
                                            alt="Arden 360 engineers designing secure network infrastructure"
                                            fill
                                            className="object-cover"
                                        />
                                    </div>
                                ...
                                <div className="col-span-7">
                                    <div className="relative h-[240px] rounded-2xl overflow-hidden shadow-xl">
                                        <Image 
                                            ...
                                            alt="Arden 360 specialists planning managed technology services"
                                            fill
                                            className="object-cover"
                                        />
                                    </div>
                        ...
                        <div>
                            ...
                            <p className="text-lg text-muted-foreground mb-12">
                                More than 1,000 organizations from regional enterprises to national brands rely on Arden 360 to modernize their technology, strengthen security, and improve operational efficiency.
                            </p>
                                        ...
                                        <div className="relative">
                                            <Avatar className="w-48 h-48 relative z-10">
                                                <AvatarImage 
                                                    src={member.image} 
                                                    alt={member.name} 
                                                    className={`object-cover transition-transform duration-700 group-hover:scale-105 ${member.name === 'Michelle Fortunato' ? 'object-top' : ''}`}
                                                />
