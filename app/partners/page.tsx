...
export default function PartnersPage() {
    return (
        ...
        <SecondaryHero8
            ...
            description="A structured partner program for MSPs, integrators, and technology providers seeking a reliable delivery partner across IT, AV, and communications services. Designed to support long-term collaboration, the Arden 360 Partnership Program provides technical resources, operational support, and flexible engagement models that help partners deliver consistent outcomes at scale."
        ...
        <PartnerProgramSection
            ...
            headline="Scale your services with Arden 360' Managed IT Partner Program"
        ...
        <PartnerProgramSection
            ...
            description="Our VoIP Partner Program supports MSPs and IT providers with cloud voice, SIP, and communication solutions fully engineered, provisioned, and supported by Arden 360."
            benefits={[
            ...
            <div className="w-full px-8 sm:px-12 lg:px-24 xl:px-32">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Join our network of trusted partners and grow your business with Arden 360. 
