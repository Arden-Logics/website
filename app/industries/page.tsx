...
export default function IndustriesPage() {
    return (
        <>
            <ServiceHeroSection
                breadcrumb="Solutions / Industries"
                title="Industries We Serve"
                description="Arden Logics provides tailored IT solutions across various industries, helping businesses transform their operations with cutting-edge technology."
